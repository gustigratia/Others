public class Main {
    ...
    public static void task4(String input){
        ...
        String num1 = input.substring(0,plusIndex);
        String num2 = input.substring(plusIndex+1);
        num1 = num1.replace("VIII", "8");
        num1 = num1.replace("VII", "7");
        num1 = num1.replace("VI", "6");
        num1 = num1.replace("V", "5");
        num1 = num1.replace("IX", "9");
        num1 = num1.replace("X", "10");
        num2 = num2.replace("VIII", "8");
        num2 = num2.replace("VII", "7");
        num2 = num2.replace("VI", "6");
        num2 = num2.replace("V", "5");
        num2 = num2.replace("IX", "9");
        num2 = num2.replace("X", "10");
        ...
        output = output.replace("20", "XX");
        output = output.replace("10", "X");
        output = output.replace("11", "XI");
        output = output.replace("1", "X");
        output = output.replace("2", "II");
        output = output.replace("3", "III");
        output = output.replace("4", "IV");
        output = output.replace("5", "V");
        output = output.replace("6", "VI");
        output = output.replace("7", "VII");
        output = output.replace("8", "VIII");
        output = output.replace("9", "IX");
